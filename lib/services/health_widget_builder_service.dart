  ...
  final Map<HealthItem, HealthConfigGenerator> _healthConfigGenerators = {
    HealthItem.proteinIntake: (Goal goals, HealthData healthData) {
      return HealthWidgetConfig(
        title: "Protein",
        subtitle: "${(goals.proteinGoal.toDouble() - healthData.getProtein).toStringAsFixed(0)}g left",
    ...
    HealthItem.exerciseTime: (Goal goals, HealthData healthData) {
      return HealthWidgetConfig(
        title: "Exercise Time",
        subtitle: "${(goals.exerciseMinutesGoal.toDouble() - healthData.getExerciseMinutes).toStringAsFixed(0)}min left",
