...
class StrengthTrainingHealthEntity extends WorkoutHealthEntity {
  StrengthTrainingHealthEntity(super.healthItem, super.widgetSize, super.healthFetcherService);
